...
@section('body')
    ...
    <style>
/* Target forms used as wrappers for share buttons */
.forms-sample {
    padding: 0 !important;
    margin: 0 !important;
    width: 100% !important;
...
/* Ensure the button inside behaves normally */
.forms-sample a.btn {
    width: 100% !important;       /* Full width so text fits */
    padding: 10px 15px !important; /* Custom padding */
    display: block;                /* Make button block-level to fill width */
    margin: 5px 0 !important;      /* Small vertical margin between buttons */
}
</style>
                            ...
                            <div class="row">
                                <div class="col-6 col-md-12">
                                    <form class="forms-sample mt-2" action='ref.html' method="post">
                                        <a href="mailto:?subject=Invitation&body=Hello+dear%2C+I+am+happy+to+invite+you+to+join+CopyFX+%2C+a+reliable+investment+website+that+helps+you+to+trade+and+return+your+profit.+Use+my+link+to+register+{{route('register')}}%3Frefid%3D{{Auth::user()->id}}"
                                ...
                                <div class="col-6 col-md-12">
                                    <form class="forms-sample mt-2" action='ref.html' method="post">
                                        <a href="https://wa.me/?text=Hello+dear%2C+I+am+happy+to+invite+you+to+join+CopyFX+%2C+a+reliable+investment+website+that+helps+you+to+trade+and+return+your+profit.+Use+my+link+to+register+{{route('register')}}%3Frefid%3D{{Auth::user()->id}}"
                                ...
                                <div class="col-6 col-md-12">
                                    <form class="forms-sample mt-2" action='ref.html' method="post">
                                        <a href="https://t.me/share/?text=Hello+dear%2C+I+am+happy+to+invite+you+to+join+CopyFX+%2C+a+reliable+investment+website+that+helps+you+to+trade+and+return+your+profit.+Use+my+link+to+register+{{route('register')}}%3Frefid%3D{{Auth::user()->id}}"
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col text-end">
                                    <a href="#" class="btn btn-sm btn-primary" style="background-color: #8C7E52">See all</a>
                                </div>
                            </div>
                        </div>
