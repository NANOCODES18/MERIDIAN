...
<div class="container">
    ...
    <form action="{{ route('kyc.submit') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('full_name') is-invalid @enderror" id="fullName" name="full_name" placeholder="Enter your full name" value="{{ old('full_name') }}" required>
            @error('full_name')
...
<option value="VA" {{ old('country') == 'VA' ? 'selected' : '' }}>Holy See</option>
...
<option value="PS" {{ old('country') == 'PS' ? 'selected' : '' }}>Palestine, State of</option>
...
<option value="SX" {{ old('country') == 'SX' ? 'selected' : '' }}>Saint Martin (Dutch part)</option>
...
<option value="SZ" {{ old('country') == 'SZ' ? 'selected' : '' }}>Eswatini (fmr. "Swaziland")</option>
...
<option value="US" {{ old('country') == 'US' ? 'selected' : '' }}>United States of America</option>
...
<option value="ZW" {{ old('country') == 'ZW' ? 'selected' : '' }}>Zimbabwe</option>
        ...
        <div class="form-group">
            ...
            <input type="text" @error('address') is-invalid @enderror value="{{ old('address') }}" class="form-control" id="address" name="address" placeholder="Address" required>
            @error('address')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-group">
            <label for="idDocument">Upload ID Document(only jpg,jpeg,png,pdf are accepted)</label>
            <input type="file" class="form-control-file" id="idDocument" placeholder="ID Upload" name="id_document" required>
            @error('id_document')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
