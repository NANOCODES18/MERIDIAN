...
<div class="col-12">
<!-- Title -->
<h1 class="text-white-stroke display-5">New Research Suggests Satoshi Nakamoto Lived in London Creating Bitcoin</h1>
<!-- Breadcrumb -->
<nav aria-label="breadcrumb">
<ol class="breadcrumb breadcrumb-dark">
<li class="breadcrumb-item"><a href="{{ route('index') }}">Home</a></li>
<li class="breadcrumb-item"><a href="#">News</a></li>
<li class="breadcrumb-item active">New Research Suggests Satoshi Nakamoto Lived in London Creating Bitcoin</li>
</ol>
</nav>
</div>
</div>
...
<h4 class="display-6 fw-bold mb-4">New Research Suggests Satoshi Nakamoto Lived in London Creating Bitcoin</h4>
...
<a class="ms-2 text-muted" href="https://www.facebook.com/share.php?u=https://wf-financial.com/welcome/read/7" target="_blank"><i class="mdi mdi-facebook fs-4"></i>Facebook</a>
<a class="ms-2 text-muted" href="https://twitter.com/share?text=New%20Research%20Suggests%20Satoshi%20Nakamoto%20Lived%20in%20London%20Creating%20Bitcoin&amp;url=https://wf-financial.com/welcome/read/7" target="_blank"><i class="mdi mdi-twitter fs-4"></i>X</a>
<a class="ms-2 text-muted" href="https://www.linkedin.com/sharing/share-offsite/?url=https://wf-financial.com/welcome/read/7" target="_blank"><i class="mdi mdi-linkedin fs-4"></i>LinkedIn</a>
</div>
</div>
</div>
</div>
...
<img alt="" class="img-fluid" src="{{ asset('assets/new-app/news/news6.jpg') }}" style="width: 50%; margin-left: auto; margin-right: auto;"/>
</div>
</div>
<div class="row justify-content-center">
