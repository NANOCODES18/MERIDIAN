...
<p class="mt-4">
            ...
            With an ever-growing selection of cryptocurrencies added to the platform, offering balanced exposure and managed by Wealth Front Financial's expert investment committee, We present many options for those who wish to trade and invest in the crypto market.
          </p>
<p class="mt-4">
...
<!-- <a href="https://wf-financial.com/welcome/investments" class="text-center text-underline link text-primary">View our Investment Scheme<i class="text-primary uil uil-arrow-right align-middle"></i></a> -->
</div>
</div>
<!--===== End of row =====-->
</div>
