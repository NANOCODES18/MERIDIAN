                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="usdttrc20"
                                                placeholder="TRC20 usdt Address"
                                                value="{{$payments? $payments->usdttrc20 :''}}">
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
                                        <div class="form-group">
                                            <label>XLM</label>
                                            <input type="text" class="form-control" name="xlm"
                                                placeholder="XLM Address"
                                                value="{{$payments? $payments->xlm :''}}">
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
                                        <div class="form-group">
